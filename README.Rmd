...
[![CRAN status](https://www.r-pkg.org/badges/version/conflr)](https://CRAN.R-project.org/package=conflr)
<!-- badges: end -->
...
* `CONFLUENCE_PAT`: Your personal access token. Used instead of username and password, depending on your confluence installation.
